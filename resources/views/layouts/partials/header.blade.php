    ...
    <ul class="nav user-menu">
        <li class="nav-item dropdown language-drop me-2">
            <a href="#" class="dropdown-toggle nav-link header-nav-list" data-bs-toggle="dropdown">
                <img src="{{ URL::asset('assets/img/icons/header-icon-01.svg') }}" alt="">
            </a>
            ...
            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <span class="user-img">
                    <img class="rounded-circle"
                        src="{{ !empty(Auth::user()->profile) ? asset(Auth::user()->profile) : asset('assets/img/profiles/avatar-02.jpg') }}"
            ...
            <div class="dropdown-menu">
                <div class="user-header">
                    <div class="avatar avatar-sm">
                        <img src="{{ !empty(Auth::user()->profile) ? asset(Auth::user()->profile) : asset('assets/img/profiles/avatar-02.jpg') }}"
