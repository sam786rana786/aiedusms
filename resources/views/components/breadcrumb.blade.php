	...
	<div class="page-header">
		<div class="row align-items-center">
			<div class="col">
				...
				'tables-basic','teacher-dashboard','teacher-details']))	
					<li class="breadcrumb-item"><a href="{{url('library')}}" >{{ $li_1 }}</a></li>
				...
				'form-mask','form-validation','form-vertical','inbox','profile','student-dashboard','student-details','tables-basic','teacher-dashboard']))	
